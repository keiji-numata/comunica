import type { IRdfJsSourceExtended } from '@comunica/actor-rdf-resolve-quad-pattern-rdfjs-source';
...
export class QuerySourceRdfJs implements IQuerySource {
  ...
  public queryBindings(operation: Algebra.Operation, context: IActionContext): BindingsStream {
    ...
    if (!quotedTripleFiltering && someTerms(operation, term => term.termType === 'Quad')) {
